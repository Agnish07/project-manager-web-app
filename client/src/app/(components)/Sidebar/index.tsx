  ...
  return (
    <div className={sidebarClassNames}>
        <div className='flex h-full w-full flex-col justify-start'>
            {/* LOGO */}
            <div className='z-50 flex min-h-14 w-64 justify-between bg-white px-6 pt-3 dark:bg-black'>
...
const SidebarLink = ({
  ...
  <div
    className={`relative flex h-10 items-center gap-3 px-4 rounded-md
  ...
  >
    {isActive && (
      <div className='absolute left-0 top-0 h-full w-[5px] bg-red-200'/>
    )}
